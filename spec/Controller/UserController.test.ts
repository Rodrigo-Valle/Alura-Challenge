...
import { userResponseDTO } from "../mocks/dto/UserMocks";
...
describe('UserController', () => {
    ...
    it('should return a token when login susscefully', async () => {
        await userControllerTest.login(mReq, mRes)
    ...
    it("should treat an error when login fails", async () => {
        jest.spyOn(UserServiceMock.prototype, 'login').mockRejectedValue(new Error('login error'));
